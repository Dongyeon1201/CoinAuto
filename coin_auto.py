...
class Coin:
    ...
    def __init__(self, korean_name, up_line_per, down_line_per):
        ...
        self.coin_korean_name = korean_name # 코인의 한글 이름
...
INPUT_COIN_NAME = sys.argv[1]
upbitUtil = UpbitUtil(API_ACCESS_KEY, API_SECRET_KEY)
MYCOIN = Coin(INPUT_COIN_NAME, up_line_per=3, down_line_per=3)

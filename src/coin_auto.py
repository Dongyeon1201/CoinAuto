...
while True:
    ...
    # 코인 미 보유 시
        ...
        elif MYCOIN.current_price > MYCOIN.up_line_price and upbitUtil.getTradeChange(MYCOIN.market_name) == 'RISE' and MYCOIN.trade_recent['candle_acc_trade_volume'] > MYCOIN.trade_vol_avg * 1.5:
